...
pub(crate) fn transform_vector_data<Data: TransformMut>(mut vector_data: Data, translate: DVec2, rotate: f64, scale: DVec2, shear: DVec2, pivot: DVec2) -> Data {
	...
	let data_transform = vector_data.transform_mut();
