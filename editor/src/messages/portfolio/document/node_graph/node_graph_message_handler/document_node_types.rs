...
use graphene_core::raster::{BlendMode, Color, DistanceFunction, Image, ImageFrame, LuminanceCalculation, NoiseType, RedGreenBlue, RelativeAbsolute, SelectiveColorChoice};
...
fn static_nodes() -> Vec<DocumentNodeType> {
	vec![
		...
		DocumentNodeType {
			name: "Perlin Noise",
			category: "General",
			identifier: NodeImplementation::proto("graphene_std::raster::PerlinNoiseNode<_, _, _, _, _, _>"),
			inputs: vec![
				DocumentInputType::value("Seed", TaggedValue::U32(0), false),
				DocumentInputType::value("Width", TaggedValue::U32(100), false),
				DocumentInputType::value("Height", TaggedValue::U32(100), false),
				DocumentInputType::value("Frequency", TaggedValue::F32(1.), false),
				DocumentInputType::value("Octaves", TaggedValue::U32(3), false),
				DocumentInputType::value("Lacunarity", TaggedValue::F32(2.), false),
		...
		DocumentNodeType {
			name: "Simplex Noise",
			category: "General",
			identifier: NodeImplementation::proto("graphene_std::raster::SimplexNoiseNode<_, _, _>"),
			inputs: vec![
				DocumentInputType::value("Seed", TaggedValue::U32(0), false),
				DocumentInputType::value("Width", TaggedValue::U32(100), false),
				DocumentInputType::value("Height", TaggedValue::U32(100), false),
			...
			outputs: vec![DocumentOutputType::new("Image", FrontendGraphDataType::Raster)],
			properties: node_properties::simplex_noise_properties,
		},
		DocumentNodeType {
			name: "Voronoi Noise",
			category: "General",
			identifier: NodeImplementation::proto("graphene_std::raster::VoronoiNoiseNode<_, _, _, _, _>"),
			inputs: vec![
				DocumentInputType::value("Seed", TaggedValue::U32(0), false),
				DocumentInputType::value("Width", TaggedValue::U32(100), false),
				DocumentInputType::value("Height", TaggedValue::U32(100), false),
				...
				DocumentInputType::value("Use Cell Values", TaggedValue::Bool(false), false),
			],
			outputs: vec![DocumentOutputType::new("Image", FrontendGraphDataType::Raster)],
