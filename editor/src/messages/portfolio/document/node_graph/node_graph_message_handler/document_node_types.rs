...
fn static_nodes() -> Vec<DocumentNodeType> {
	vec![
		...
		DocumentNodeType {
			name: "Simplex Noise",
			category: "General",
			identifier: NodeImplementation::proto("graphene_std::raster::SimplexNoiseNode<_, _, _, _, _, _>"),
			inputs: vec![
				DocumentInputType::value("Seed", TaggedValue::U32(0), false),
				DocumentInputType::value("Width", TaggedValue::U32(100), false),
				DocumentInputType::value("Height", TaggedValue::U32(100), false),
		...
		DocumentNodeType {
			name: "Voronoi Noise",
			category: "General",
			identifier: NodeImplementation::proto("graphene_std::raster::VoronoiNoiseNode<_, _>"),
			inputs: vec![
				DocumentInputType::value("Seed", TaggedValue::U32(0), false),
				DocumentInputType::value("Width", TaggedValue::U32(100), false),
				DocumentInputType::value("Height", TaggedValue::U32(100), false),
			...
			outputs: vec![DocumentOutputType::new("Image", FrontendGraphDataType::Raster)],
			properties: node_properties::noise_properties,
		},
		DocumentNodeType {
			name: "Mask",
